        ...
        switch (algorithmType) {
            ...
            case MOCell:
                return new MOCellBuilder<PlanningSolution>(problem, crossover, mutation)
                        ...
                        .setPopulationSize(2000) // TODO: any number > 100 makes the algorithm to trigger an exception: org.uma.jmetal.util.JMetalException: The solution list size 101 is not equal to the grid size: 10 * 10
                        .build();
            case SPEA2:
